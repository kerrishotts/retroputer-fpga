...
#
# Script generated by Vivado on Sat Jan 20 20:34:17 -0500 2024
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/fpga/LEDtoButton/cores/managed_ip_project/managed_ip_project.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
