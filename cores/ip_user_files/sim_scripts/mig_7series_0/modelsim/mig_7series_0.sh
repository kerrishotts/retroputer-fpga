...
#
# Script generated by Vivado on Sat Jan 20 17:21:17 -0500 2024
...
copy_setup_file()
{
  file="modelsim.ini"
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/fpga/LEDtoButton/cores/managed_ip_project/managed_ip_project.cache/compile_simlib/modelsim"
  fi
